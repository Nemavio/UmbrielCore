...
?>
<html><body bgcolor="#749CAC">
<center><table style="text-align: left; width: 100%;" bgcolor="#F0F0F0" border="0" cellpadding="0" cellspacing="0"><tbody><tr><td width="274" style="vertical-align: top;"><p><strong><font color="#00000">Nombre de personnes dans la salle</font></strong></p></td><td width="36" style="vertical-align: top;">
<input type="text" size="6" value="<?php echo $requete_rentres;?>" disabled></td></tr><tr><td style="vertical-align: top;"><font color="#00000">Nombre de personnes venues</font></td>
<td style="vertical-align: top;"><input type="text" size="6" value="<?php echo $personnes_venues;?>" disabled></td></tr><tr><td style="vertical-align: top;">
<font color="#00000">Nombre de personnes sorties</font></td><td style="vertical-align: top;"><input type="text" size="6" value="<?php echo $requete_sortis;?>" disabled></td></tr><tr>
<td style="vertical-align: top;"><font color="#00000">Nombre de personnes non-d&eacute;clar&eacute;es </font></td><td style="vertical-align: top;">
<input type="text" size="6" value="<?php echo $requete_nodeclare;?>" disabled></td></tr><tr><td style="vertical-align: top;"><font color="#0000FF"><strong>Nombre total d'inscrits</strong> </font></td>
<td style="vertical-align: top;"><input type="text" size="6" value="<?php echo $inscrits_total;?>" disabled>
</td></tr>
<?php
mysql_select_db($base, $connexion); 
$rdspapt = mysql_query('SELECT * FROM '.$tableparam.' WHERE type="grade" AND valeur2="'.$_SESSION['idbdd'].'" ORDER BY valeur1');
				while($wrdspapt = mysql_fetch_array($rdspapt)){
				mysql_select_db($base, $connexion); 
				$rnbrusprasd = mysql_query('SELECT * FROM '.$varserv['valeur4'].' WHERE tarif="'.$wrdspapt['valeur1'].'" ORDER BY id');
				$nrrnbrusprasd = mysql_num_rows($rnbrusprasd);
					echo ('<tr><td style="vertical-align: top;"><font color="#0000FF"><img src="img/fldroit.png"> '.$wrdspapt['valeur3'].'</font></td><td style="vertical-align: top;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="text" size="6" value="'.$nrrnbrusprasd.'" disabled></td></tr>');
				}	  
?>
<tr><td style="vertical-align: top;"><font color="#FF0000"><strong>Nombre d'argent total (pr&eacute;visions)</strong></font></td><td style="vertical-align: top;">
<input type="text" size="6" value="<?php echo(''.$argent_total.'€');?>" disabled></td><tr/></tbody></table></center>
</body></html>
<?php
}else{
?>
	...
	if((isset($_GET['page'])) && $_GET['page']=='rentrees') {
		echo("<strong><u>Les personnes rentr&eacute;es...(".$requete_rentres.")</u></strong><br />");
			...
			$pr_01 = mysql_query('SELECT prenom, nom, id FROM '.$varserv['valeur4'].' WHERE rentre="1" ORDER BY nom');
				while($datapr_01 = mysql_fetch_array($pr_01)){
		...
		echo("<strong><u>Les personnes sorties...(".$requete_sortis.")</u></strong><br />");
			...
			$pr_02 = mysql_query('SELECT prenom, nom, id FROM '.$varserv['valeur4'].' WHERE sorti="1" ORDER BY nom');
				while($datapr_02 = mysql_fetch_array($pr_02)){
		...
		echo("<u><strong>Les personnes inscrites...(".$inscrits_total.")</strong></u>");
			...
			$pr_03 = mysql_query('SELECT id, nom, prenom FROM '.$varserv['valeur4'].' ORDER BY nom');
				while($datapr_03 = mysql_fetch_array($pr_03)){
		...
		echo("<u><strong>Les personnes...(".$inscrits_total.")</strong></u>");
			...
			$pr_04 = mysql_query("SELECT nom, id, prenom FROM ".$varserv['valeur4']." WHERE replace(nom,'Ö','O') like '".$_GET['lettre']."%' OR replace(nom,'Ô','O') like '".$_GET['lettre']."%' OR replace(nom,'Ä','A') like '".$_GET['lettre']."%' OR replace(nom,'Â','A') like '".$_GET['lettre']."%' ORDER BY nom");
				while($datapr_04 = mysql_fetch_array($pr_04)){
					echo ("<br /><a href=\"utilisateurs.php?utilisateur=".$datapr_04['id']."&url=infos.php\">".$datapr_04['nom']."&nbsp;".$datapr_04['prenom']."</a>");
				}
} else {?>                       
<table style="text-align: left; width: 100%; margin-left: auto; margin-right: auto; height: 30px;" border="0" cellpadding="2" cellspacing="1"><tbody><tr><td width="439" style="vertical-align: top; text-align: center;"><strong><u>Les 
...
?>
</td><td width="440" style="vertical-align: top; text-align: center;"><strong><u>Les personnes sorties...(<?php echo $requete_sortis;?>)</u></strong><br />
<?php 
	mysql_select_db($base, $connexion);
	$pr_02 = mysql_query('SELECT prenom, nom, id FROM '.$varserv['valeur4'].' WHERE sorti="1" ORDER BY nom');
		while($datapr_02 = mysql_fetch_array($pr_02)){
...
?>
</td></tr></tbody></table><table style="text-align: left; width: 100%; margin-left: auto; margin-right: auto; height: 32px;" border="0" cellpadding="2" cellspacing="2"><tbody><tr>
...
<?php
  ...
  <div id="infos" class="rubrique">
  	<table style="text-align: left; width: 310px;" bgcolor="#F0F0F0" border="0" cellpadding="0" cellspacing="0"><tbody><tr>
<td width="274" style="vertical-align: top;"><p><strong><font color="#00000">Nombre de personnes dans la salle</font></strong></p></td><td width="36" style="vertical-align: top;">
<input type="text" size="6" value="<?php echo $requete_rentres;?>" disabled></td></tr><tr><td style="vertical-align: top;"><font color="#00000">Nombre de personnes venues</font></td>
<td style="vertical-align: top;"><input type="text" size="6" value="<?php echo $personnes_venues;?>" disabled></td></tr><tr><td style="vertical-align: top;">
<font color="#00000">Nombre de personnes sorties</font></td><td style="vertical-align: top;"><input type="text" size="6" value="<?php echo $requete_sortis;?>" disabled></td></tr><tr>
<td style="vertical-align: top;"><font color="#00000">Nombre de personnes non-d&eacute;clar&eacute;es </font></td><td style="vertical-align: top;">
<input type="text" size="6" value="<?php echo $requete_nodeclare;?>" disabled></td></tr><tr><td style="vertical-align: top;"><font color="#0000FF"><strong>Nombre total d'inscrits</strong> </font></td>
<td style="vertical-align: top;"><input type="text" size="6" value="<?php echo $inscrits_total;?>" disabled>
</td></tr><tr><td style="vertical-align: top;"><font color="#FF0000"><strong>Nombre d'argent total (pr&eacute;visions)</strong></font></td><td style="vertical-align: top;">
<input type="text" size="6" value="<?php echo(''.$argent_total.'€');?>" disabled></td></tr></tbody></table></center></div><a id="plustab" class="plustab" href="index.php?opt=plustab">+++</a><hr align="center">
<table width="100%" border="0">
  <tr>
    <td width="30%" align="left"><form id="formgen"><input type="button" value="Inscrire une personne" onClick="self.location.href='modifier.php?typemodif=inscription'"></form></td>
    <td width="40%" align="center"><form action="utilisateurs.php" method="get"><input name="mashup" type="text" width="75%" size="75%" id="gensearch" class="gensearch" onClick="submit" onKeyPress="13"><input name="go" type="submit" id="gogen" value="&gt;&gt;"></form></td>
    <td width="30%" align="right"><form><input type="button" value="Rechercher & faire entrer ou sortir une personne" onClick="self.location.href='search.php'"></form></td>
  </tr>
</table>
<hr align="center"><p><font size="+2"><strong><u>Derni&egrave;res entr&eacute;es</u></strong></font></p>
<table style="text-align: left; width: 100%; margin-left: auto; margin-right: auto; height: 30px;" border="0" cellpadding="2" cellspacing="1"><tbody><tr><td width="439" style="vertical-align: top; text-align: center;">
<strong><u>Les 5 derni&egrave;res personnes rentr&eacute;es...</u></strong><br />
<?php 
mysql_select_db($base, $connexion);
...
?>
</td><td width="440" style="vertical-align: top; text-align: center;"><strong><u>Les 5 derni&egrave;res personnes sorties...</u></strong><br />
<?php 
	mysql_select_db($base, $connexion);
